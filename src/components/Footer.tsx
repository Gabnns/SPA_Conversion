        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400">
              Transformando negócios através de soluções inovadoras e eficientes.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#benefits" className="text-gray-400 hover:text-white transition">Benefícios</a></li>
              <li><a href="#how-it-works" className="text-gray-400 hover:text-white transition">Como Funciona</a></li>
              <li><a href="#testimonials" className="text-gray-400 hover:text-white transition">Depoimentos</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-400">contato@brandname.com</li>
